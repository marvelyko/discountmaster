...
def send_mail(email,url,price):
    ...
    If our website helped you save money, if you are willing to fund us with even $1, because we could offer better opportunities. 
    SmartDiscount wishes you a good purchase.
